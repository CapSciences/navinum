...
$(document).ready(function(){
  $('#synchro_manuelle').click(function(){
		...
		console.log($("#synchro_manuelle").attr('env'))
		if($("#synchro_manuelle").attr('env') == 'test'){
			var url = '/sync_ajax_test.php/default/syncAjax';
		}else{
			var url = '/sync_ajax.php/default/syncAjax';
		}
		console.log(url);
		$.get(url,
